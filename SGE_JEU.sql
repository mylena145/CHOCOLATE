...
('C006', 120.5, 80.0, 60.0, 500.0),
('C007', 100.0, 75.0, 55.0, 450.0)
ON CONFLICT (id_cellule) DO NOTHING;
...
(1, 3, 50.0, 5.5, 'R1-E1'),    -- Remplacez 6 par le vrai id_reception
(2, 4, 60.0, 6.0, 'R1-E2'),    -- Remplacez 7 par le vrai id_reception
(3, 5, 55.0, 7.0, 'R2-E1'),    -- Remplacez 8 par le vrai id_reception
(4, 6, 65.0, 6.5, 'R2-E2'),    -- Remplacez 9 par le vrai id_reception
(5, 7, 70.0, 8.0, 'R3-E1');   -- Remplacez 10 par le vrai id_reception-- Remplacez 10 par le vrai ID
-- Insertion dans lots
...
-- Insérer avec des IDs plus courts
-- Alternative avec des lettres
